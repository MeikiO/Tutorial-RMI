...
public class ConversorMonedas {
    public static void main(String args[]) {
        try {
            ...
            ConversorMonedas programa=new ConversorMonedas();
            Transaccion task = programa.introducir_datos();
    ...
    public Transaccion introducir_datos() {
        ...
        Transaccion task = new Transaccion(montonInicial,elegida);
