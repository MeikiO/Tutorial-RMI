...
public class Subcontrata_1 extends UnicastRemoteObject implements Subcontratacion {
    ...
    private final static int NUMPUERTO_SUBCONTRATA=1091;
    private final static String NOMBRESERVER="Subcontrata1";
    
    private Random random;

    public Subcontrata_1(String string) throws RemoteException {
      super();
      this.mensaje=string;
